...
Thank you for contributing to Quaestor (the "Project"), owned by Felix
...
does not transfer ownership; it only grants the licenses above. You are free to
use your Contribution for any other purpose.
...
Unless required by law, your Contribution is provided "as is", without warranty
of any kind.

---

By opening a pull request against this Project, you certify that you have read
